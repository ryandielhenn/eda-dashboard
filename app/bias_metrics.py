...
# ───────────────────────────────
# Categorical Bias Metrics
# ───────────────────────────────
def categorical_bias_metrics_duckdb(duckdb_path: str, table_name: str, col: str) -> dict | None:
    """Compute categorical bias metrics using shared DuckDB connection"""
    con = connect()
